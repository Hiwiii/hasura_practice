...
export const getServerSideProps: GetServerSideProps = async (context) => {
  ...
  const data = await fetch(process.env.NEXT_PUBLIC_HASURA_PROJECT_ENDPOINT as string, {
    headers: {
...
const Home: NextPage=({friends}: InferGetServerSidePropsType<typeof getServerSideProps>) => {
  return (
    <div
